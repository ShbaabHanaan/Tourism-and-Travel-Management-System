...
<div id="deletePopup" class="modal">
    <div class="modal-content">
        ...
        <div style='display: flex; justify-content: space-around;'>
            <button class="table-btn"onclick="confirmDelete()">Yes, Delete</button>
            <button class="table-btn" onclick="closePopup()">Cancel</button>
        </div>
    </div>
</div>
...
<script>
    ...
    function confirmDelete() {
        if(deleteId !== null) {
            window.location.href = 'delete_bookings.php?id=' + deleteId;
        }
    }
    ...
    function showLoadingAndNavigate(id) {
        ...
        setTimeout(function() {
            ...
            window.location.href = 'update_bookings.php?id=' + id;
        }, 500);
    }
</script>
</body>
