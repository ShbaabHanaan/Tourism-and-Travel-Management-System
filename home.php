...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            <a href="user_dashboard_page/userdashboard.php" >Dashboard</a>
        ...
        <a  href="logout.php"><button class="btn-signin" id="signin-btn" >Logout</button></a>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <a href="package_page/packages.php">Get Started</a>
        </div>
    </section>
